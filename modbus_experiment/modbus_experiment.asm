...
;modbus_experiment.c,52 :: 		SPI_Ethernet_getBytes(buf, ERDPT, reqLength);
	PUSH       R9
	PUSH       R8
	MOVW       R6, R8
	CLR        R4
...
;modbus_experiment.c,57 :: 		PrintOut(PrintHandler, "%#2X ");
	PUSH       R19
	PUSH       R18
	PUSH       R9
	PUSH       R8
...
;modbus_experiment.c,54 :: 		for(i = 0;i < reqLength; i++)
	...
	SBCI       R17, 255
	MOVW       R18, R16
;modbus_experiment.c,58 :: 		}
; i end address is: 18 (R18)
	JMP        L_SPI_Ethernet_UserTCP1
L_SPI_Ethernet_UserTCP2:
;modbus_experiment.c,60 :: 		UART_Write_Text("\n\r");
	PUSH       R9
	PUSH       R8
	PUSH       R7
	PUSH       R6
	...
	POP        R8
	POP        R9
;modbus_experiment.c,62 :: 		return(0);
	LDI        R16, 0
	LDI        R17, 0
;modbus_experiment.c,63 :: 		}
;modbus_experiment.c,62 :: 		return(0);
;modbus_experiment.c,63 :: 		}
...
;modbus_experiment.c,65 :: 		unsigned int  SPI_Ethernet_UserUDP(unsigned char *remoteHost, unsigned int remotePort, unsigned int destPort, unsigned int reqLength, TEthPktFlags *flags)
; flags start address is: 16 (R16)
	LDD        R16, Y+0
	LDD        R17, Y+1
; flags end address is: 16 (R16)
;modbus_experiment.c,67 :: 		return(0);
	LDI        R16, 0
	LDI        R17, 0
;modbus_experiment.c,68 :: 		}
...
;modbus_experiment.c,73 :: 		void    main()
;modbus_experiment.c,75 :: 		OSC_CTRL = 0x02;                 // 32MHz internal RC oscillator
	PUSH       R2
	PUSH       R3
	PUSH       R4
	PUSH       R5
	...
	LDI        R27, 2
	STS        OSC_CTRL+0, R27
;modbus_experiment.c,76 :: 		while(RC32MRDY_bit == 0)
L_main4:
	LDS        R27, RC32MRDY_bit+0
	SBRC       R27, BitPos(RC32MRDY_bit+0)
	JMP        L_main5
;modbus_experiment.c,77 :: 		;
	JMP        L_main4
L_main5:
;modbus_experiment.c,78 :: 		CPU_CCP = 0xD8;
	LDI        R27, 216
	OUT        CPU_CCP+0, R27
;modbus_experiment.c,79 :: 		CLK_CTRL = 1;
	LDI        R27, 1
	STS        CLK_CTRL+0, R27
;modbus_experiment.c,88 :: 		PORTC_DIR.B7 = 1;
	LDS        R27, PORTC_DIR+0
	SBR        R27, 128
	STS        PORTC_DIR+0, R27
;modbus_experiment.c,89 :: 		PORTC_DIR.B5 = 1;
	LDS        R27, PORTC_DIR+0
	SBR        R27, 32
	STS        PORTC_DIR+0, R27
;modbus_experiment.c,90 :: 		PORTC_DIR.B6 = 0;
	LDS        R27, PORTC_DIR+0
	CBR        R27, 64
	STS        PORTC_DIR+0, R27
;modbus_experiment.c,91 :: 		PORTB_DIR.B6 = 0;
	LDS        R27, PORTB_DIR+0
	CBR        R27, 64
	STS        PORTB_DIR+0, R27
;modbus_experiment.c,92 :: 		PORTB_OUT.B6 = 0;
	LDS        R27, PORTB_OUT+0
	CBR        R27, 64
	STS        PORTB_OUT+0, R27
;modbus_experiment.c,93 :: 		PORTC_DIR.B0 = 1;
	LDS        R27, PORTC_DIR+0
	SBR        R27, 1
	STS        PORTC_DIR+0, R27
;modbus_experiment.c,94 :: 		PORTC_DIR.B1 = 1;
	LDS        R27, PORTC_DIR+0
	SBR        R27, 2
	STS        PORTC_DIR+0, R27
;modbus_experiment.c,96 :: 		UARTC0_Init(115200);
	...
	CALL       _UARTC0_Init+0
;modbus_experiment.c,97 :: 		UART_Set_Active(&UARTC0_Read, &UARTC0_Write, &UARTC0_Data_Ready, &UARTC0_Tx_Idle);
	...
	OUT        SPL+0, R26
	OUT        SPL+1, R27
;modbus_experiment.c,99 :: 		UART_Write_Text("Starting\n\r");
	LDI        R27, #lo_addr(?lstr3_modbus_experiment+0)
	MOV        R2, R27
	LDI        R27, hi_addr(?lstr3_modbus_experiment+0)
	MOV        R3, R27
	CALL       _UART_Write_Text+0
;modbus_experiment.c,101 :: 		SPIC_Init_Advanced(_SPI_MASTER, _SPI_FCY_DIV16, _SPI_CLK_LO_LEADING);
	CLR        R4
	LDI        R27, 1
	MOV        R3, R27
	LDI        R27, 16
...
;modbus_experiment.c,102 :: 		SPI_Set_Active(&SPIC_Read,&SPIC_Write);
...
;modbus_experiment.c,103 :: 		Spi_Rd_Ptr = SPIC_Read;
	LDI        R27, #lo_addr(_SPIC_Read+0)
	STS        _SPI_Rd_Ptr+0, R27
	LDI        R27, hi_addr(_SPIC_Read+0)
	STS        _SPI_Rd_Ptr+1, R27
;modbus_experiment.c,104 :: 		SPI_Ethernet_Init(myMacAddr, myIpAddr, Spi_Ethernet_FULLDUPLEX) ;
	LDI        R27, 1
	MOV        R6, R27
...
;modbus_experiment.c,107 :: 		SPI_Ethernet_confNetwork(ipMask, gwIpAddr, dnsIpAddr) ;
...
;modbus_experiment.c,109 :: 		while(1) // do forever
L_main6:
;modbus_experiment.c,114 :: 		SPI_Ethernet_doPacket() ;   // process incoming Ethernet packets
	CALL       _SPI_Ethernet_doPacket+0
;modbus_experiment.c,121 :: 		}
	JMP        L_main6
;modbus_experiment.c,122 :: 		}
L_end_main:
	POP        R7
	POP        R6
	POP        R5

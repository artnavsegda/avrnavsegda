...
void tc_callback(void)
{
	...
	frame.data.bypass_pressure = press_data.pressure.value;
	frame.data.t_analytical_cell = temp_data.temperature.value;

	frame.data.t_selftest_cell = adc_scan_results[3];
	frame.data.pressure_analytical_cell = adc_scan_results[4];

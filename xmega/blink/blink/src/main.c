...
int main (void)
{
	...
	pca9557_set_pin_dir(0x1a, PCA9557_IO1, PCA9557_DIR_OUTPUT);
	pca9557_set_pin_dir(0x1a, PCA9557_IO2, PCA9557_DIR_OUTPUT);
	pca9557_set_pin_dir(0x1a, PCA9557_IO3, PCA9557_DIR_OUTPUT);
	pca9557_set_pin_dir(0x1a, PCA9557_IO4, PCA9557_DIR_OUTPUT);
	pca9557_set_pin_dir(0x1a, PCA9557_IO5, PCA9557_DIR_OUTPUT);
	pca9557_set_pin_dir(0x1a, PCA9557_IO6, PCA9557_DIR_OUTPUT);
	pca9557_set_pin_dir(0x1a, PCA9557_IO7, PCA9557_DIR_OUTPUT);
	...
	while (1)
	{
		...
		pca9557_set_pin_level(0x1a, 3, false);
		pca9557_set_pin_level(0x1a, 4, true);
		pca9557_set_pin_level(0x1a, 5, false);
		pca9557_set_pin_level(0x1a, 6, true);
		pca9557_set_pin_level(0x1a, 7, false);
		delay_ms(500);
	}
}

...
int main (void)
{
	...
	//pca9557_set_pin_low(0x1a, 0);
	//pca9557_set_pin_high(0x1a, 1);
	//pca9557_set_pin_high(0x1a, 2);
	//pca9557_set_pin_high(0x1a, 3);
	//pca9557_set_pin_high(0x1a, 4);
	//pca9557_set_pin_high(0x1a, 5);
	//pca9557_set_pin_low(0x1a, 6);
	//pca9557_set_pin_low(0x1a, 7);
	i2c_send(&TWIE, 0x18, 0x03, 0x00);
	i2c_send(&TWIE, 0x19, 0x03, 0x00);
